...
exec { 'install_ruby':
  ...
  command => "${as_vagrant} '${home}/.rvm/bin/rvm install ruby-${ruby_version} --binary --autolibs=enabled && rvm alias create default ${ruby_version} && rvm --default use ${ruby_version}'",
